...
2. **Architectural Compliance**:
   - **Console Usage**: No native `console.log` is used within core logic. `console.error` is appropriately used in the `bootstrap()` wrapper _before_ the Ink TUI is mounted.
